 ...
 * @subpackage Steves_Bike_Maintenance/public
 */
 ...
 */
class Steves_Bike_Maintenance_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $Steves_Bike_Maintenance       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->Steves_Bike_Maintenance, plugin_dir_url( __FILE__ ) . 'css/steves-bike-maintenance-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->Steves_Bike_Maintenance, plugin_dir_url( __FILE__ ) . 'js/steves-bike-maintenance-public.js', array( 'jquery' ), $this->version, false );
